		...
		<nav class="navbar navbar-expand gap-3">
			...
			<div class="user-box dropdown px-3">
				...
				<ul class="dropdown-menu dropdown-menu-end">
					<li><a class="dropdown-item d-flex align-items-center" href="<?= base_url()?>super_admin/update_profile"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
					</li>
					<li>
						<div class="dropdown-divider mb-0"></div>
					</li>
					<li><a class="dropdown-item d-flex align-items-center" href="<?= base_url()?>login/logout"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
					</li>
				</ul>
			</div>
		</nav>
