...
class Api extends REST_Controller {
	...
	public function index_post() {
		$data = array(
			'not_title' => $this->post('not_title') ?? 'Default Title',
			'not_category' => $this->post('not_category') ?? 'Default Category',
			'not_description' => $this->post('not_description') ?? 'Default Description',
			'not_thumbnail' => $this->post('not_thumbnail') ?? 'Default Thumbnail',
		);
