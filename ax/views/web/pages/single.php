        ...
        <div class="section group">
                    ...
                    <div class="price">
                        <p>Price: <span>Tk.<?php 
                                                if ($this->session->userdata('customer_email')) {
                                                    echo $this->cart->format_number($get_single_product->product_price);
                                                }else{
            ...
            <div class="rightsidebar span_3_of_1">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo base_url('get/category/'.$single_category->category_url_name);?>"><?php echo $single_category->category_name?></a></li>
                    <?php }?>
                </ul>
