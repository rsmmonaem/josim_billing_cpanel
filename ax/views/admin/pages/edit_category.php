                ...
                <form class="form-horizontal" action="<?php echo base_url('update/category/'.$category_info_by_id->id);?>" method="post">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="span6 typeahead" id="category_url_name" value="<?php echo $category_info_by_id->category_url_name;?>"  name="category_url_name" type="text"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                 <input type="color" id="favcolor" name="bgcolor" value="<?php echo $category_info_by_id->bgcolor;?>" style="height: 94px; width: 152px;">
                            </div>
                        </div> 
                         ...
                         <div class="control-group">
                            ...
                            <div class="controls">
                                 <input type="file" id="favcolor" value="<?php echo $category_info_by_id->cat_image;?>" name="cat_image" style="height: 94px; width: 152px;">
                            </div>
                        </div>
                        <div class="control-group">
